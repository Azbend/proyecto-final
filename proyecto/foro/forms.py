...
class FormularioNuevoJuego(forms.ModelForm):
    class Meta:
        model = Consola
        fields = ('usuario', 'titulo', 'consola', 'producto', 'descripcion', 'año', 'precio', 'imagen')
...
class ActualizacionJuego(forms.ModelForm):
    class Meta:
        model = Consola
        fields = ('titulo', 'consola', 'producto', 'descripcion', 'año', 'precio', 'imagen')
